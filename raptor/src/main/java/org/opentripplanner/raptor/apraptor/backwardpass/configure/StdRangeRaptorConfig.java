package org.opentripplanner.raptor.apraptor.backwardpass.configure;
...
import org.opentripplanner.raptor.apraptor.backwardpass.ArrivalTimeRoutingStrategy;
import org.opentripplanner.raptor.apraptor.backwardpass.MinTravelDurationRoutingStrategy;
import org.opentripplanner.raptor.apraptor.backwardpass.StdRangeRaptorWorkerState;
import org.opentripplanner.raptor.apraptor.backwardpass.StdTransferEarlyPruning;
import org.opentripplanner.raptor.apraptor.backwardpass.StdWorkerState;
import org.opentripplanner.raptor.apraptor.backwardpass.besttimes.BestTimes;
import org.opentripplanner.raptor.apraptor.backwardpass.besttimes.BestTimesOnlyStopArrivalsState;
import org.opentripplanner.raptor.apraptor.backwardpass.besttimes.SimpleArrivedAtDestinationCheck;
import org.opentripplanner.raptor.apraptor.backwardpass.besttimes.SimpleBestNumberOfTransfers;
import org.opentripplanner.raptor.apraptor.backwardpass.besttimes.UnknownPathFactory;
import org.opentripplanner.raptor.apraptor.backwardpass.debug.DebugStopArrivalsState;
import org.opentripplanner.raptor.apraptor.backwardpass.heuristics.HeuristicsAdapter;
import org.opentripplanner.raptor.apraptor.backwardpass.internalapi.ArrivedAtDestinationCheck;
import org.opentripplanner.raptor.apraptor.backwardpass.internalapi.BestNumberOfTransfers;
import org.opentripplanner.raptor.apraptor.backwardpass.internalapi.StopArrivalsState;
import org.opentripplanner.raptor.apraptor.backwardpass.stoparrivals.APStopArrivals;
import org.opentripplanner.raptor.apraptor.backwardpass.stoparrivals.APStopArrivalsState;
import org.opentripplanner.raptor.apraptor.backwardpass.stoparrivals.path.EgressArrivalToPathAdapter;
import org.opentripplanner.raptor.apraptor.backwardpass.stoparrivals.view.StopsCursor;
...
public class StdRangeRaptorConfig<T extends RaptorTripSchedule> {
  ...
  private APStopArrivals<T> stopArrivals;
  ...
  private StopArrivalsState<T> stdStopArrivalsState() {
    var state = oneOf(
      new APStopArrivalsState<>(resolveStopArrivals(), destinationArrivalPaths()),
      StopArrivalsState.class
    );
  ...
  private APStopArrivals<T> resolveStopArrivals() {
    if (stopArrivals == null) {
      this.stopArrivals = withBestNumberOfTransfers(
        oneOf(
          new APStopArrivals<T>(ctx.nRounds(), ctx.nStops(), ctx.lifeCycle()),
          APStopArrivals.class
        )
      );
    }
    return stopArrivals;
