...
import org.opentripplanner.raptor.apraptor.backwardpass.internalapi.DestinationArrivalListener;

/**
 * @param <T> The TripSchedule type defined by the user of the raptor API.
 */
public final class APStopArrivals<T extends RaptorTripSchedule> implements BestNumberOfTransfers {

  /** Arrivals by round and stop - [round][stop] */
  private final StopArrivalState<T>[][] arrivals;
  private int round;

  public APStopArrivals(int nRounds, int nStops, WorkerLifeCycle lifeCycle) {
